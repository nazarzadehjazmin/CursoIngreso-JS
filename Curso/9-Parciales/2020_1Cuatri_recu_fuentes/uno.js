...
function mostrar() {
	...
	if (contadorJabon != 0) {
		...
		document.write("<br><b>Cantidad de unidades del jabón más caro: </b> No hay");
	...
	/*
	dice=con mas unidades
	total de la compra=es una vuelta
	total de lo INGRESADO=si quisiera sacar el total para acumular
	CON MAXIMOS
	
	se puede hacer con variable i (contador)
	
	i==0 --> es la primera vez que entro
	if(i==0 || cantidadUnidadesProducto>mayorCantidadPorUnidades){
		mayorcantidadporunidad=cantidadunidadesproducto;
		tipoconmayorcantidades=tiporpoducto;
		preciodelmayor=precioproducto;
	}
 promediodelmayor = mayorcantidadporunidad / preciodelmayor;
